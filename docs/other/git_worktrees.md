...
export EXPERIMENTS_PATH=../traitinterp/experiments
...
```bash
cd trait-interp-my-feature
echo 'export EXPERIMENTS_PATH=../traitinterp/experiments' > .envrc
direnv allow
```
...
ln -s ../traitinterp/experiments experiments  # create
