...
Usage:
    # Start server
    python -m utils.server.app --port 8765 --model google/gemma-2-2b-it

    # In scripts
    from utils.server import get_model_or_client, ModelClient
...
from utils.server.client import get_model_or_client, ModelClient, is_server_available
