...
def load_model(
    ...
    """
    Load model and tokenizer. Delegates to load_model_with_lora for full
    feature support (flash attention, MoE fusion, model cache, TP, NaN fix).
...
def load_model_with_lora(
    ...
    Returns:
        (model, tokenizer) tuple
    """
    from utils.moe import _patch_moe_forward, save_model_cache, _get_model_cache_dir, _fast_load_cached
