...
|---|---|---|---|---|
| **1. Reflective** | L29–L33 | `melancholy, reflective, depressed, brooding, gloomy, worn_out` | peak aligned (z = +3.88 at L29, +3.48 at L31, +2.83 at L33; L25 also raw-sig at z = +2.09 but with different top-10) | 4/10 direct |
| **2. Contentment** | L37–L43 | `blissful, content, at_ease, satisfied, cheerful` | mildly aligned | 0/10 |
| **3. Activation** | L49–L73 | `eager, impatient, enthusiastic, energized` | all 5 sampled layers in this band significantly opposite (z = −2.04 at L49 → −2.95 at L73) | 0/10 |
