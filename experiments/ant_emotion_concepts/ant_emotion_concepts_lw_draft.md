...
2. **Geometric projection** — PC1 (valence) opposition is robust across all 4 Llama scoring methods: canonical normalized top-10 at PC1=+0.856 (paper's method), cross-version raw-dot at +0.52, 4-emotion intersection at +0.44, within-version raw-dot at +0.13, vs Sonnet at −0.43. PC2 (arousal) opposition is method-dependent: full "both axes opposed" holds only for the 4-emotion intersection (PC1=+0.44/PC2=+0.42) and cross-version raw-dot clusters. The canonical paper-methodology top-10 is valence-only opposed with neutral PC2. Jaccard=0 applies specifically to the 4-emotion intersection cluster vs Sonnet's top-10, and broader raw-dot lists have partial overlap at `weary`.
