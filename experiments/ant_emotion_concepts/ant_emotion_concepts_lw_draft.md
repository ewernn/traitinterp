...
3. **At L49–L67, Llama is in activation-flavored positive-valence.** Top-10 `eager, impatient, enthusiastic, energized, stimulated, alert, excited`. This is the phase earlier drafts headlined as "opposite Sonnet's direction." Sonnet-alignment score is negative here (z ≈ −0.7 to −1.2, peak opposite at L73 z=−1.23).
