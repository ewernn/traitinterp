...
So what's really going on at L49 is: **canonical normalized scoring at L49 surfaces a top-10 that looks contentment-flavored and correlates more with the L43 raw-dot shift than with the L49 raw-dot shift.** That's interesting — it suggests canonical scoring may have "longer-range" sensitivity, or simply that it normalizes differently in a way that happens to emphasize emotions peaking at earlier layers. We don't know. What we can say with confidence:
