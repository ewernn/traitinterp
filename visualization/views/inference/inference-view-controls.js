    ...
    return `
        <div class="tool-view${window.state.wideMode ? ' wide-mode' : ''}">
            ...
            <section>
                ...
                <div class="subsection-info" id="info-top-spans">Top-ranked token spans for the trait, ranked by deviation from this response's own mean (per-response mean-centered) so within-response peaks surface instead of absolute magnitude. In diff mode, values are main &minus; comparison; positive = main expresses it more.</div>
